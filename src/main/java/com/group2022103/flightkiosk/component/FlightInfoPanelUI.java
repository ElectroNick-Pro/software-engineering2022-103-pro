...
public class FlightInfoPanelUI extends JPanel {
	...
	private JLabel bookID, date, airlineLabel, takeoff, arrive, flightNo, airport1, airport2, startTime, arriveTime,
			time, seat,
			food, Terminal, TerminalNum, GateNo, Gate, name, ID, picture, seatClass, classNo, foodChoice;

	public FlightInfoPanelUI(String flightbookID, String flightDate, String airline, String flightTakeoff,
			String flightArrive,
